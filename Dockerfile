...
RUN apt-get update --allow-releaseinfo-change && apt-get install -yqq --no-install-recommends python3-dev python3-pip gcc g++ libpq-dev
...
CMD /usr/bin/uwsgi ./etc/uwsgi.ini
