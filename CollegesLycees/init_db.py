...
corr_reussite_pro["Presents_Services_collectivite"] = (
    "presents_services_collectivite",
    to_int,
)
...
corr_mention_pro["Mentions_Services_collectivite"] = (
    "mentions_services_collectivite",
    to_int,
)
corr_mention_pro["VA_Services_collectivite"] = (
    "va_mention_services_collectivite",
    to_int,
)
